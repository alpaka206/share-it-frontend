      ...
      <div className="Need-detail">
        ...
        <div className="Need-detail-content-container">
          <div className="Need-detail-content">
            {renderContentWithLineBreaks(data.content)}
          </div>
          <div>
            <div className="Need-detail-user">
              <div className="Need-detail-user-info-image-container">
                <img
                  ...
                  alt="mypage"
                  className="Need-detail-user-info-image"
                />
              </div>
              <div className="Need-detail-user-info-name">
                {userData.username}
              </div>
              <div className="Need-detail-user-info-star-rating">
                <Rating
                  value={4.5}
                  precision={0.5}
                  readOnly
              ...
              <button
                className="Need-detail-chat-button"
        ...
        <div className="Need-detail-hashtags-container">
          {renderHashTags(data.hashTag)}
        </div>
        ...
        >
          {data.imageKeys.map((key, index) => (
            <div key={index} className="Need-detail-image-wrapper">
              <img
                src={key}
                alt={`Need Detail ${index}`}
                className="Need-detail-image"
              />
            </div>
          ))}
        </div>
