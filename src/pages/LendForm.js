...
function Lend_form() {
    ...
    const handleSubmit = async () => {
        ...
        // Convert productInfo with new lines to HTML line breaks
        const productInfoHTML = productInfo.replace(/\n/g, '<br>');
        formData.append('productInfo', productInfoHTML);

        try {
            // Send POST request to backend server
            const response = await axios.post('http://your-backend-url/upload-photos', formData, {
                headers: {
