    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (response.data.code.includes('SEC-001') || response.data.code.includes('SEC-002')) {
            ...
            <div className="lend-detail-first-container">
                ...
                <div className="lend-detail-product-info">
                    ...
                    <div className="lend-detail-price">
                        {lendDetailData.cost}원<span className="lend-detail-days"> / {lendDetailData.perDate}일</span>
                    </div>
