...
const SocialRegister = () => {
    ...
    const handleNext = async (e, ref) => {
        ...
        if (ref === fifthDivRef) {
            ...
            try {
                const response = await axios.post(`https://catholic-mibal.site/auth/mail`, {
        ...
        if (ref === sixDivRef) {
            try {
                const response = await axios.post(`https://catholic-mibal.site/auth/email-code`, {
            ...
            <div>
                ...
                <div className="firstDivRef">
                    ...
                    <div className="checkbox-container-first">
                        ...
                        >
                            <button id="agree" className={`checkbox-check ${userState.agreeCheck ? 'checked' : ''}`}>
                                {userState.agreeCheck && (
                                    <img src="/assets/register_check.svg" alt="Checked" className="checkmark" />
                                )}
                            </button>
                            <div className="firstDivRef-agree-text">개인정보 수집 및 이용에 동의합니다.</div>
                        </div>
                        <div className="second-button-container">
                            <button onClick={(e) => handleNext(e, fourthDivRef)} className="second-button">
                                시작하기
                            </button>
                        </div>
                    </div>
                ...
                <div className="fourthDivRef" ref={fourthDivRef}>
                    ...
                    <div className="fourthDivRef-input">
                        ...
                        {buttonCheck.Emailbtn && (
                            <img
                                src={buttonCheck.emailCheck ? '/assets/approved.svg' : '/assets/delete_red.svg'}
                                alt="reset"
                            />
                        )}
                    </div>
                    <div className="fourthDivRef-second">
                        <div className="fourthDivRef-secondtext">보다 신뢰할 수 있는 거래를 위해 필요해요.</div>
                ...
                <div className="fifthDivRef" ref={fifthDivRef}>
                    ...
                    <div className="fifthDivRef-input">
                        ...
                        {buttonCheck.EmailPWbtn && (
                            <img
                                src={buttonCheck.emailpwCheck ? '/assets/approved.svg' : '/assets/delete_red.svg'}
                                alt="reset"
                            />
                        )}
                    </div>
